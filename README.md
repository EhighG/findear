...
<img src="/media/image/img_logo.jpg" width="600" height="300">
...
<img width="1000" alt="image" src="/media/image/img_archi.png
">
...
<img src="/media/image/img_social.jpeg" width="300" height="500">

### 2. 시설 관리자 등록

- 카카오맵 키워드 검색을 통해 본인의 시설을 검색하고 편리하게 관리자 등록  
  <img src="/media/image/img_register1.png" width="300" height="500">
  <img src="/media/image/img_register2.jpg" width="300" height="500">
...
- 무한 스크롤 연동
  <img src="/media/image/img_search.jpg" width="300" height="500">
...
<img src="/media/image/img_ai_register1.png" width="300" height="500">
<img src="/media/image/img_ai_register2.png" width="300" height="500">
...
<img src="/media/image/img_management.png" width="300" height="500">
...
<img src="/media/image/img_lost_register.png" width="300" height="500">

### 7. 유사 습득물 매칭

- 분실자가 등록한 분실물 정보와 Findear에서 보유중인 습득물 데이터를 이용한 매칭 서비스 제공  
  <img src="/media/image/img_matching.png" width="300" height="500">

### 8. 쪽지 기능

- 분실자는 매칭되거나 습득물 페이지에서 본인의 물건을 보유중이라고 생각하는 시설 관리자에게 쪽지를 보낼 수 있다.  
  <img src="/media/image/img_message.png" width="300" height="500">

### 9. 웹푸시, 백그라운드 알림

- PWA 웹푸시 API를 활용하여 쪽지, 매칭 등 이벤트 발생시 사용자에게 실시간으로 알려줍니다.  
  <img src="/media/image/img_webpush.png" width="300" height="500">
...
<img src="/media/image/img_turnover.png" width="300" height="500">

### 11. 다크 모드

- 다크 모드 반영으로 사용자의 편의성을 생각했습니다.

<img src="/media/image/img_darkmode1.png" width="300" height="500">
<img src="/media/image/img_darkmode2.png" width="300" height="500">
...
<img src="/media/image/img_erd.PNG" width="1000" height="500">
